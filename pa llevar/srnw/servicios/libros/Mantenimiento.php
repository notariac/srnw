...
<table width="550" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td colspan="2">
<input type="text" class="inputtext" style="font-size:12px; width:350px;" name="0form1_razonsocial" id="RazonSocial"  value="<?php echo $row['nombre']; ?>" <?php echo $Enabled;?> onkeypress="CambiarFoco(event, 'Ruc');"/></td>
  </tr>
  <tr>
