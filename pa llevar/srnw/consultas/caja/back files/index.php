...
<script>
	...
	function Imprimir(){
            ...
            var Pagina = "impresion.php?Fecha=" + Fecha + "&Opcion=" + OpcImpresion + Comprobante + TipoPago;
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="163" class="cabecera" align="right">Fecha:&nbsp;</td>
    <td colspan="6">
      <input type="text" name="Fecha" id="Fecha" class="inputtext" readonly="readonly" value="<?php echo $Fecha;?>" style="width:80px"/></td>
  </tr>
  <tr>
    <td colspan="7">&nbsp;</td>
  </tr>
  ...
  <tr id="FilaPago">
    ...
    <td><label>
      <select name="TipoPago1" id="TipoPago1" class="select_1">
      	<option value="3" >--Seleccione el Tipo--</option>
