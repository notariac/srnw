...
class PDF extends FPDF{
	...
	// Carga de datos
	$SQL = 	"SELECT kardex.idkardex, kardex.correlativo, kardex.escritura, kardex.placa, kardex.escritura_fecha, kardex.fojafin FROM kardex INNER JOIN servicio ON (servicio.idservicio = kardex.idservicio) WHERE substr(kardex.correlativo, 1, 1) = 'V' AND kardex.escritura_fecha BETWEEN '$Desde' AND '$Hasta' AND kardex.idnotaria='".$_SESSION['notaria']."' ORDER BY kardex.escritura_fecha ASC, kardex.escritura ASC ";
