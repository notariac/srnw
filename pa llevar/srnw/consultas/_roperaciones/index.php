<?php
    ...
    $FormatoGrilla[6] = array('TP'=>$TAMANO_PAGINA);                  //Registro por Paginas
    ...
    $FormatoGrilla[9] = array('Id'=>'1', 						//Botones de Acciones
                              'NB'=>'2',						//Numero de Botones a agregar
                              'BtnId1'=>'BtnArchivo', 	//Nombre del Boton
                              'BtnI1'=>'word.png', 	//Imagen a mostrar
                              'Btn1'=>'Abrir Archivo', 			//Titulo del Boton
                              'BtnF1'=>'onclick="ImprimirA(this.id);"',	//Eventos del Boton
                              'BtnCI1'=>'8', 	//Item a Comparar
                              'BtnCV1'=>'1',
                              'BtnCC1'=>'==',
                              'BtnId2'=>'BtnArchivo', 	//Nombre del Boton
                              'BtnI2'=>'open.gif', 	//Imagen a mostrar
                              'Btn2'=>'Abrir Parte Adjuntado', 			//Titulo del Boton
                              'BtnF2'=>'onclick="ImprimirP(this.id);"',	//Eventos del Boton
