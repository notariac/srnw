...
if(!session_id()){session_start();}	
    ...
    $nPost = array();
    $nPost = $_POST;
    if ($_POST['0form1_idcliente']=='')
    {

        $SqlC = "INSERT INTO cliente(idcliente_tipo, iddocumento, dni_ruc, nombres, direccion, estado, idusuario, fechareg) VALUES('1', '".$_POST['0form1_iddocumento']."', '".$_POST['0form1_dni_ruc']."', '".$_POST['0form1_nombres']."', '".$_POST['0form1_direccion']."', '1', '".$_POST['0form1_idusuario']."', '".$Conn->CodFecha($_POST['3form1_fechareg'])."');";
