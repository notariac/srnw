<?php 
    ...
    else
    {
        $plantilla = '<div id="contenedor" style="background:#dadada">
                        <div style="width:793px; margin:0 auto; padding:0 0 50px 0;">
                        <div id="idmargen_top" style="width:793px; height:50px;"></div>
                        <div class="page" style="box-shadow: 10px 10px 8px #888888;width:548px; padding:0 45px 50px 196px; background:#FFFFFF;font-size: 14pt;font-family:\"Times New Roman\",arial,Times,serif;">
                            <div style="min-height:600px" id="page">
                                 <div>&nbsp;</div>
                            </div>
                        </div>  
                        </div>     
