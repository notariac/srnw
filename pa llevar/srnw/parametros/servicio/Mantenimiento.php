<?php	
    ...
    if($Id!=''){
        ...
        $SQL2 = " SELECT asigna_pdt.idacto_juridico, servicio.idservicio, asigna_pdt.iddocumento_notarial FROM asigna_pdt INNER JOIN servicio ON servicio.idservicio=asigna_pdt.idservicio WHERE servicio.idservicio= '$Id' ";        
