...
$Enabled2 = "readonly";
if($Id!=''){
    $Select 	= "SELECT * FROM forma_pago WHERE idforma_pago = '$Id'";
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><input type="text" class="inputtext" style="text-align:center; width:50px" name="1form1_idforma_pago" id="Id" maxlength="2" value="<?php echo $row[0];?>" <?php echo $Enabled2;?> onkeypress="CambiarFoco(this, 'Descripcion')"/>
    </td>
  </tr>
  <tr>
