...
if(!session_id()){session_start();}
	...
	switch ($oper) {
		...
		case 1:
				...
				break;	
		case 2: 
			$sql = "DELETE FROM cliente_representante where idcliente = {$_POST['1formA_idcliente']}";
			$sql2 = "DELETE FROM cliente where idcliente = {$_POST['1formA_idcliente']}";
			$q = $Conn->Query($sql);
			$q = $Conn->Query($sql2);
			print_r(json_encode(array('1','','Se ha eliminado correctamente')));
			break;
		default:
			# code...
			break;
