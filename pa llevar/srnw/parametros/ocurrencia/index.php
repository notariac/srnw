<?php
    ...
    $TituloVentana = "Mantenimiento de Ocurrencia";
    $Criterio = "ocurrencia";	
    CuerpoSuperior($TituloVentana);
    $Op = isset($_GET['Op'])?$_GET['Op']:0;
    $FormatoGrilla = array ();
    $Sql = "SELECT id".$Criterio.", descripcion, estado FROM ".$Criterio;
    ...
    $FormatoGrilla[8] = " ORDER BY id".$Criterio." ASC ";                                   //Orden de la Consulta
