...
function decena($numdero){	
		if ($numdero >= 90 && $numdero <= 99){
			$numd = "NOVENTA ";
			if ($numdero > 90) $numd = $numd."Y ".(unidadK($numdero - 90));
		}else if ($numdero >= 80 && $numdero <= 89){
			$numd = "OCHENTA ";
			if ($numdero > 80) $numd = $numd."Y ".(unidadK($numdero - 80));
		}else if ($numdero >= 70 && $numdero <= 79){
			$numd = "SETENTA ";
			if ($numdero > 70) $numd = $numd."Y ".(unidadK($numdero - 70));
		}else if ($numdero >= 60 && $numdero <= 69){
			$numd = "SESENTA ";
			if ($numdero > 60) $numd = $numd."Y ".(unidadK($numdero - 60));
		}else if ($numdero >= 50 && $numdero <= 59){
			$numd = "CINCUENTA ";
			if ($numdero > 50) $numd = $numd."Y ".(unidadK($numdero - 50));
...
function CantidadEnLetraP($tyCantidad){  
$tyCantidad = round($tyCantidad * 100) / 100; 
$lyCantidad = (int)$tyCantidad; 
$lyCentavos = ($tyCantidad - $lyCantidad) * 100; 
$lyCentavos = round($lyCentavos * 100) / 100; 
