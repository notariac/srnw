...
<?php			
			for ($ii=1; $ii<=$FormatoGrilla[9]['NB']; $ii++){
				...
				if (($Condicion && $row[6]==$_SESSION['id_user']) || ($FormatoGrilla[9]['BtnId'.$ii]=='BtnVer')){
?>
...
?>
			<img width="15" src="<?php echo $_SESSION["../fueraregistros/urlDir"];?>imagenes/iconos/blanco.png" border="0"/>
<?php					
				}
			}
?>
