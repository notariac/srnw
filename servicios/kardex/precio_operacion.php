...
<input type="text" align="left" class="inputtext" style="font-size:12px; width:80px; text-transform:uppercase;" name="0form1_monto" id="PrecioOperacion" value="<?php if($row['monto']!="") echo number_format($row['monto'],2); else echo "0.00"; ?>" <?php echo $Enabled;?> onkeypress="CambiarFoco(event, 'FormaPago'); return permite(event, 'num');"/>