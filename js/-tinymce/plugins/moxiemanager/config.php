<?php
	// General
	$moxieManagerConfig['general.license'] = 'L6ZL-ZPEQ-C6BA-TFV3-J5OO-YGDU-D5JM-4C7T';
	...
	$moxieManagerConfig['general.language'] = 'es';
	...
	$moxieManagerConfig['upload.max_width'] = 550;
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "andrez", "password" => "12345678", "groups" => array("administrator"))
	);
