<?php 
    ...
    $Id = $_GET['idkardex'];
    $sql = "SELECT digital from kardex
             where idkardex = ".$Id;
...
<body id="tinymce" class="mce-content-body " onload="window.parent.tinymce.get('content').fire('load');" spellcheck="false" dir="ltr" style="">
