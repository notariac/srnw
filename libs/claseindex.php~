         ...
         <div style="width:<?php echo $Tamano-21;?>px; padding:10px; margin:0 0 10px; border-top:0" class="ui-widget-content ui-corner-bottom">
            ...
            <table width="100%" border="0" >
                <tr style="font-size:15px">
                  ...
                  <td valign="middle" align="left"><input type="text" name="Valor" id="Valor" style="width:100%" value="<?php echo $Valor;?>" onkeyup="ValidarEnter(this, '<?php echo $Op;?>');"  class="inputtext"/></td>
