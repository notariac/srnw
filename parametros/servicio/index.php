...
if(!session_id()){ session_start(); }
    ...
    $TituloVentana = "Mantenimiento de Servicios";
    $Criterio = "servicio";	
    CuerpoSuperior($TituloVentana);
    $Op = isset($_GET['Op'])?$_GET['Op']:0;
    $FormatoGrilla = array ();
    $Sql = "SELECT servicio.idservicio, servicio.descripcion, servicio.precio, servicio.legal, kardex_tipo.abreviatura, servicio.estado ";
    $Sql = $Sql." FROM servicio INNER JOIN kardex_tipo ON (servicio.idkardex_tipo = kardex_tipo.idkardex_tipo)";
    $FormatoGrilla[0] = $Sql;             		//Sentencia SQL
    $FormatoGrilla[1] = array('1'=>'servicio.idservicio', '2'=>'servicio.descripcion', '3'=>'servicio.precio', '4'=>'kardex_tipo.abreviatura');  //Campos por los cuales se har� la b�squeda
    $FormatoGrilla[2] = $Op; 	   //Operacion
    $FormatoGrilla[3] = array('T1'=>'C&oacute;digo', 'T2'=>'Descripci&oacute;n', 'T3'=>'Precio', 'T4'=>'Legal', 'T5'=>'Tipo Kardex', 'T6'=>'Estado');   			//T�tulos de la Cabecera
    $FormatoGrilla[4] = array('A1'=>'center', 'A3'=>'center', 'A4'=>'center', 'A5'=>'center', 'A6'=>'center');                        //Alineaci�n por Columna
    $FormatoGrilla[5] = array('W1'=>'50', 'W3'=>'100', 'W4'=>'70', 'W5'=>'70', 'W6'=>'70');     //Ancho de las Columnas
    $FormatoGrilla[6] = array('TP'=>$TAMANO_PAGINA);                  //Registro por P�ginas
    $FormatoGrilla[7] = 850;                                   //Ancho de la Tabla
    $FormatoGrilla[8] = " ORDER BY servicio.idservicio ASC ";         //Orden de la Consulta
