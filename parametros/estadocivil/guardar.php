<?
	...
	$Sql = $mantem->__dbMantenimiento($_POST, "form1", "estado_civil", $Op);	//Se genera la sentencia SQL de acuerdo a la operación
	...
	if (!$Consulta)
	{
		...
		$Res=2;
		$Mensaje ="Error al intentar ".$Accion[$Op]." los datos del Estado Civil: ";
	}
	else
	{
