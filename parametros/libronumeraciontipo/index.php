<?php
    ...
    $TituloVentana = "Mantenimiento de Tipo de Numeraci&oacuten";
    $Criterio = "libro_numeracion_tipo";	
    ...
    $FormatoGrilla[1] = array('1'=>'id'.$Criterio, '2'=>'descripcion');  				//Campos por los cuales se har� la b�squeda
    ...
    $FormatoGrilla[8] = " ORDER BY idlibro_numeracion_tipo ASC ";                                   //Orden de la Consulta
