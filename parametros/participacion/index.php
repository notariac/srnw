<?php
    ...
    $TituloVentana = "Mantenimiento de Tipo de Participaci&oacute;n";
    $Criterio = "participacion";	
    CuerpoSuperior($TituloVentana);
    $Op = isset($_GET['Op'])?$_GET['Op']:0;
    $FormatoGrilla = array ();
    $Sql = "SELECT idparticipacion, descripcion, estado ";
    $Sql = $Sql." FROM participacion ";
    $FormatoGrilla[0] = $Sql;                                                           //Sentencia SQL
    $FormatoGrilla[1] = array('1'=>'idparticipacion', '2'=>'descripcion');  				//Campos por los cuales se har� la b�squeda
    ...
    $FormatoGrilla[8] = " ORDER BY idparticipacion ASC ";                                   //Orden de la Consulta
