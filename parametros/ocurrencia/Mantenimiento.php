<?php
	...
	if($Op==2 || $Op==3){
        ...
        $Enabled2 = "readonly";
	if($Id!=''){
            $Select 	= "SELECT * FROM ocurrencia WHERE idocurrencia = '$Id'";
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><input type="text" class="inputtext" style="text-align:center; width:50px" name="1form1_idocurrencia" id="Id" maxlength="2" value="<?php echo $row[0];?>" <?php echo $Enabled2;?> onkeypress="CambiarFoco(this, 'Descripcion')"/>
    </td>
  </tr>
  <tr>
